-- ============================================================
-- PROYECTO INMOBILIARIO V2 - CARGA DE DATOS 
-- PostgreSQL 16+
-- ============================================================
...
-- 3. INSERCIÓN DE USUARIOS (Corregido campo created_at)
...
('U-0001', 1), -- Carlos Admin
('U-0002', 2), -- Laura Agente
('U-0003', 3), -- Juan Cliente
('U-0004', 3), -- Ana Cliente
('U-0005', 2); -- Diego Agente
...
-- 6. INSERCIÓN DE PROPIEDADES (Corregido mapeo numérico de tipo_propiedad_id)
...
('P-0001', 'U-0003', 1, '08003', 'REF-0001', 'Piso luminoso en la Barceloneta', 'Espectacular piso reformado a pocos metros de la playa.', 'Passeig Marítim, Barcelona', 'alquiler', 1350.00, 65.00, 2, 1, 'publicada'),
('P-0002', 'U-0002', 1, '28001', 'REF-0002', 'Chalet exclusivo en Recoletos', 'Propiedad de lujo con calidades premium en el centro de Madrid.', 'Calle Serrano, Madrid', 'venta', 1250000.00, 240.00, 4, 3, 'publicada'),
('P-0003', 'U-0004', 1, '08001', 'REF-0003', 'Estudio moderno en El Raval', 'Ideal para estudiantes o parejas. Completamente amueblado.', 'Carrer de la Cera, Barcelona', 'alquiler', 950.00, 45.00, 1, 1, 'publicada'),
('P-0004', 'U-0003', 3, '41001', 'REF-0004', 'Local comercial en Centro de Sevilla', 'Gran visibilidad peatonal, salida de humos instalada.', 'Calle Sierpes, Sevilla', 'renta', 3200.00, 120.00, 0, 2, 'publicada');

-- Ajustar los IDs correctos basados en los códigos para evitar conflictos secuenciales
UPDATE propiedades SET tipo_propiedad_id = (SELECT id FROM tipos_propiedad WHERE codigo = 'CASA') WHERE id_propiedad = 'P-0002';
UPDATE propiedades SET tipo_propiedad_id = (SELECT id FROM tipos_propiedad WHERE codigo = 'LOCAL') WHERE id_propiedad = 'P-0004';

-- 7. INSERCIÓN DE INTERACCIONES (MENSAJES - Corregido manejo de remitente opcional)
...
-- Mensaje anónimo sin violar el dominio de usuario obligatorio
INSERT INTO mensajes (id_mensaje, fk_propiedad, fk_remitente, tipo_remitente, nombre, email, telefono, mensaje) VALUES
